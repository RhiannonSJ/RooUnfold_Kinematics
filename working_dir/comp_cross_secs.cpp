...
void Slices( TH2D *h_a, TH2D *h_1, TH2D *h_2, TH2D *h_3, double norm );
...
void comp_cross_secs(){
    ...
    double Tmu_bins = h_all->GetYaxis()->GetBinWidth(1);
    ...
    Slices( h_ddxsec_all, h_ddxsec_1p, h_ddxsec_2p, h_ddxsec_3p, scalar_norm );
...
void Slices( TH2D *h_a, TH2D *h_1, TH2D *h_2, TH2D *h_3, double norm ){
    ...
    for ( int i = 1; i <= y_bins; ++i ){
        ...
        conv << setprecision(4) << "/hepstore/rjones/Exercises/RooUnfold_Kinematics/working_dir/xsec/Tmu_slice_" << low_edge_T << ";" << up_edge_T << ".png";
        title = conv.str();
        ...
        double max = 1.1 * TMath::Max(max_1, TMath::Max(max_2, TMath::Max( max_3, max_a ))); 
    ...
    for ( int i = 1; i <= x_bins; ++i ){
        ...
        conv1 << setprecision(4) << "/hepstore/rjones/Exercises/RooUnfold_Kinematics/working_dir/xsec/cos_thetamu_slice_" << low_edge_cos << ";" << up_edge_cos << ".png";
        title1 = conv1.str();
        ...
        double max_c = 1.1 * TMath::Max(max_1_c, TMath::Max(max_2_c, TMath::Max(max_3_c, max_a_c))); 
