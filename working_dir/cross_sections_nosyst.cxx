...
void cross_sections_nosyst( const int &n_protons, const char pr_path[1024] ) {
    //==============================================================================
    ...
    temp_stats << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/stats.txt";
    ...
    temp_tr << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_2D_true.png";
    ...
    temp_ct << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_2D_cut.png";
    ...
    temp_re << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_2D_reco.png";
    ...
    temp_unf << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_2D_unfolded.png";
    ...
    temp_cmp << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_true_unfold_comp.png";
    ...
    temp_eff << "working_dir/G16_01b_uboone_smearing/" << pr_path <<  "/" << pr_path <<"_efficiency.png";
    ...
    temp_ddx << "working_dir/G16_01b_uboone_smearing/" << pr_path << "/" << pr_path << "_2D_unfolding_ddxsec.png";
...
void Slices ( TH2D *h_unfolded, TH2D *h_true, TH2D *h_reco, const char n_pr[1024] ){
    ...
    for ( int i = 1; i <= y_bins; ++i ){
        ...
        conv << setprecision(4) << "working_dir/G16_01b_uboone_smearing/" << n_pr << "/Tmu_slice_" << low_edge_T << ";" << up_edge_T << ".png";
        title = conv.str();
    ...
    for ( int i = 1; i <= x_bins; ++i ){
        ...
        conv1 << setprecision(4) << "working_dir/G16_01b_uboone_smearing/" << n_pr << "/cos_thetamu_slice_" << low_edge_cos << ";" << up_edge_cos << ".png";
        title1 = conv1.str();
